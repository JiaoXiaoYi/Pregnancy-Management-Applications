...
# 加载数据集
data_all = pd.read_csv("C:\\Users\\Administrator\\Desktop\\新建文件夹\\分词\\第二版本-4-分词输入.csv")
...
# 加载停用词
stop_words_path = "C:\\Users\\Administrator\\Desktop\\新建文件夹\\分词\\stop word2.txt" #自己导入停用词表，可以根据结果不断更新,文件夹中停用词表是4个词表组成的
...
# 数据预处理的结果输出
data_all.to_csv('C:\\Users\\Administrator\\Desktop\\新建文件夹\\分词\\lda_test2.csv')
